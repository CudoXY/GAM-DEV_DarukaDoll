...
public class BlockColor {
	...
	public static readonly BlockColor BLUE = new BlockColor(1, "Blue", Color.blue, KeyCode.D);
	public static readonly BlockColor GREEN = new BlockColor(2, "Green", Color.green, KeyCode.S);
